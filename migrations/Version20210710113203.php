 ...
 */
final class Version20210710113203 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, file_name VARCHAR(255) NOT NULL, is_active TINYINT(1) NOT NULL, title VARCHAR(255) NOT NULL, INDEX IDX_C53D045F4584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE measure (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(3) NOT NULL, short_name VARCHAR(20) NOT NULL, full_name VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product_balance (id INT AUTO_INCREMENT NOT NULL, product_supply_id INT DEFAULT NULL, product_id INT NOT NULL, order_id_id INT DEFAULT NULL, size_id INT NOT NULL, color_id INT NOT NULL, quantity NUMERIC(18, 3) NOT NULL, reserved NUMERIC(18, 3) NOT NULL, INDEX IDX_7D2D044E91887655 (product_supply_id), INDEX IDX_7D2D044E4584665A (product_id), INDEX IDX_7D2D044EFCDAEAAA (order_id_id), INDEX IDX_7D2D044E498DA827 (size_id), INDEX IDX_7D2D044E7ADA1FB5 (color_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product_supply_list (id INT AUTO_INCREMENT NOT NULL, product_supply_id INT NOT NULL, product_id INT NOT NULL, size_id INT NOT NULL, color_id INT NOT NULL, quantity NUMERIC(18, 3) NOT NULL, INDEX IDX_530F021E91887655 (product_supply_id), INDEX IDX_530F021E4584665A (product_id), INDEX IDX_530F021E498DA827 (size_id), INDEX IDX_530F021E7ADA1FB5 (color_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE products_and_services (id INT AUTO_INCREMENT NOT NULL, measure_code_id INT NOT NULL, is_product TINYINT(1) NOT NULL, is_active TINYINT(1) NOT NULL, title VARCHAR(255) NOT NULL, INDEX IDX_CE50D835BCA12A6F (measure_code_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE products_and_services ADD CONSTRAINT FK_CE50D835BCA12A6F FOREIGN KEY (measure_code_id) REFERENCES measure (id)');
    }
